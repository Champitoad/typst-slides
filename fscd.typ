...
#slide(title: [The scroll])[
  ...
  #side-by-side(gutter: 2em, columns: (1fr, 2fr))[
    #set align(center)
    #image("images/scroll.png", width: 60%)
    #uncover("2-")[
    ...
    #only("3-")[
      #nscroll(
        fontsize: 18pt,
        outloop: (content: align(top)[$A #juxt B$], size: 2cm),
        inloops: ((:), (content: $C #juxt D$, size: 1.1cm))
      ).content
...
#slide(title: [Related works (non-exhaustive)])[
  ...
  #side-by-side(columns: (3fr, 2fr))[
    ...
    - *Categorical logic:*
      ...
      - @bonchi_diagrammatic_2024: algebra of #sys[Beta] ~~#text(size: 16pt)[(LICS 2024)]
    ][
